  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      response.customers.forEach(function (element, key) {
        ...
        var voucher = '';
        if (operation == 'vendor') {
          var _element$rec$0$total_, _element$rec$0$total_2, _element$cpv_no, _element$crv_no;
