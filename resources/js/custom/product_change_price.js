    ...
    filtered_Array.forEach((element, key) => { 
        $('.productTable tbody').append(`
            <tr data-product-id="${element.id}">
                ...
                <td><input type="text"  class="inputvalue only_numerics" value="${element.sale_price}"  data-purchase="${element.new_purchase_price ? element.new_purchase_price : element.old_purchase_price}"  data-id="${key + 1}" name="sale_price" tabindex="3" min="0"></td>
