...
$(document).on('input change', '.qty', function () {
  ...
  if (qty > stock_in_hand) {
    ...
    $('#notifDiv').fadeIn();
    $('#notifDiv').css('background', 'red');
    $('#notifDiv').text("".concat(stock_in_hand > 0 ? "Qty should be less than " + displayStockBalance(stock_in_hand) : 'Product is Out of Stock!'));
    setTimeout(function () {
      $('#notifDiv').fadeOut();
    }, 3000);
    return;
