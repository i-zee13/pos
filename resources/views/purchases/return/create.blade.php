                ...
                <div class="modal-body AddDetailPR">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-15">
                            <div class="form-s2">
                                <select class="form-control formselect" id="productItems"
                                    onchange="itemUnitPrice(this);" placeholder="Select Item" style="width:100%">
                        ...
                        <div class="col-md-8 mb-15">
                            <input type="number" id="itemQty" class="form-control" placeholder=""
                                style="font-size:13px">
                        </div>
                        <div class="col-md-4 PT-8" style="padding-top: 2px">Unit Price:</div>
                        <div class="col-md-8">
                            <input type="text" id="itemUnitPrice" class="form-control" placeholder=""
                                style="font-size:13px">
                        </div>
                    </div>
    ...
    @section('content')
        ...
        <div class="container-fluid">
            <form id="form" enctype="multipart/form-data" class="">
                @csrf
                <div class="row">
                    <input type="hidden" id="hidden_invoice_id" class="form-control " value="{{ @$invoice->id }}"
                        name="hidden_invoice_id">
                    <input type="hidden" id="curren_customer_id" class="form-control "
                        value="{{ @$invoice->customer_id }}" name="customer_id">
                    <input type="hidden" id="service_charges" class="form-control "
                        value="{{ @$invoice->service_charges }}" name="service_charges">
                    <input type="hidden" name="customer_ledger" id="customer_ledger"
                        value="{{ json_encode(@$get_customer_ledger) }}">
                        ...
                        <div class="sidebox-content">
                            <div class="CT_sec">
                                ...
                                <div class="col-md-12 PB-10">
                                    ...
                                    <div class="form-s2">
                                        <select class="form-control formselect form_clear required" name="invoice_type"
                                ...
                                <div class="col-md-12 PB-10">
                                    ...
                                    <div class="form-s2">
                                        <input type="Date" name="invoice_date"
                                            class="form-control new_dob new_form_field "
                                            value="{{ @$invoice ? $invoice->date : $current_date }}">
                                    </div>
                                </div>
                                ...
                                <div class="row CompanyInfo">
                                    ...
                                    <div class="col-md-5"><span
                                            class="dashboard_avg_rev_perCust {{ request()->query('invoice') == 'detail' ? '' : 'previous_payable' }}">{{ request()->query('invoice') == 'detail' ? $invoice->previous_receivable : '' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8 right-sid ebox">
                        ...
                        <div class="right_Info">
                            <div class="row inputfileds-top">
                                <div class="row CompanyInfo">
                                    <div class="col-md-3"><strong class="show_purchase">P.P:</strong> <span
                                            class="pp" style="display:none"></span></div>
                                    <div class="col-md-5"><strong>Retail Price:</strong> <span class="retail_price ml-10"
                                            style="font-family: 'Rationale', sans-serif !important;font-size: 27px;color:red">0</span>
                                    </div>
                                    <div class="col-md-4 pr-0"><strong>Stock Balance:</strong><span
                                            class="stock_balance ml-10"
                                            style="font-family: 'Rationale', sans-serif !important;font-size: 27px;color:red">0</span>
                                    </div>
                                    ...
                                    <form id="purchse-form">
                                        <div class="row">
                                            <input type="text" id="purchase_price"
                                                class="inputfileds  purchase_price " placeholder="" name="purchase_price"
                                                hidden>
                                            <input type="text" id="retail _price" class="inputfileds" placeholder=""
                                                name="ret ail_price" hidden>
                                            <input id="datepicker" type="hidden"
                                                class="inputfileds new_dob new_form_field expiry_date "
                                                name="expiry_date">
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12" id="table-container">
                                    <table class="ProductTable table  " id="designationsTable" width="100%"
                                        ...
                                        <tbody id="productGrid">
                                            <tr>
                                                <td><input type="text" id="bar-code" class="inputSale bar-code"
                                                        placeholder="" name="bar_code" data-attr='bar_code'
                                                        tabindex="1" style="width: 40;"></td>
                                                <td>
                                                    <div class="form-s2" style="width:165px">
                                                        <select class="inputfileds formselect products"
                                                            name="product_name" id="products" tabindex="2"
                                                            style="width: 140;">
                                                ...
                                                <td> <input type="date" id="expiry_date" class="inputSale expiry_date"
                                                        placeholder="Expiry Date" name="expiry_date " tabindex="5"
                                                        style=" width: 95;"></td>
                                                <td> <input type="number" id="qty" class="inputSale only_numerics"
                                                        placeholder="" name="qty" tabindex="3" min="0"
                                                        style="width: 50;"></td>
                                                <td><input type="number" id="retail_price" class="inputSale"
                                                        placeholder="" name="retail_price" style="font-size: 13px"
                                                        readonly></td>
                                                <td><input type="number" id="discount" class="inputSale"
                                                        placeholder="" name="discount" style="font-size: 13px;width: 50;"
                                                        tabindex="4" min="0"></td>
                                                <td class='add- S-input '><input type="number" id="amount"
                                                        class="inputSale" placeholder="" name="amount"
                                                        style="font-size: 13px;width: 65;"></td>
                                                <td>
                                                    <button type="button" id="add-product"
                                                        class="btn btn-primary smBTN mr-2" tabindex="5"
                                                        style="padding: 5px 15px 5px 15px; background:green">Add</button>
                                                </td>
                                            </tr>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <table class="totalValues" width="100%" border="0" cellspacing="0"
                                        cellpadding="0">
                                        <tbody>
                                            <tr class="th-to-hide">
                                                <td></td>
                                                ...
                                                <td> <input type="number" class="inputvalue product_net_total"
                                                        name="product_net_total" style="font-size: 13px"
                                            ...
                                            <tr class="th-to-hide">
                                                ...
                                                <td style="width:112px"><input type="number" name="discount"
                                                        id="discount" class="inputvalue service_charges_input"
                                                        style="font-size: 13px" value="{{ @$invoice->service_charges }}"
                                                        placeholder="0.00" data-id="" data-value="" min="0">
                                                </td>
                                            </tr>
                                            <tr class="previous_payable_tr" style="display:none">
                                                <td></td>
                                                <td></td>
                                                <td align="right" class="previous_payable_heading">Previous Receivable
                                                </td>
                                                <td
                                                    class="{{ request()->query('invoice') == 'detail' ? '' : 'previous_payable' }}">
                                                    {{ request()->query('invoice') == 'detail' ? $invoice->previous_receivable : '0' }}
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="th-to-hide">
                                                ...
                                                <td> <input type="number" class="inputvalue " id="invoice_discount"
                                                        name="invoice_discount" style="font-size: 13px"
                                                        placeholder="0.00" min="0"
                                                        value="{{ @$invoice->invoice_discount }}"></td>
                                            ...
                                            <tr class="th-to-hide">
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <input type="number"
                                                            class="inputvalue  remaning_amount amount_pay_input "
                                                            id="amount_ to_pay" name="amount_to_pay"
                                                            style="font-size: 13px" placeholder="0.00" readonly
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" class="inputvalue amount_received"
                                                        id="amount_received" name="amount_received"
                                                        style="font-size: 13px" placeholder="0.00"
                                                        value="{{ @$invoice->paid_amount }}"></td>
                                            </tr>
                                            ...
                                            @if (Route::currentRouteName() == 'purchase-edit')
                                                <tr class="th-to-hide" hidden>
                                                    ...
                                                    <td class="paid_amount">
                                                        {{ @$invoice->paid_amount ? @$invoice->paid_amount : 0 }}</td>
                                                </tr>
                                            @endif
                                            <tr>
                                                <td></td>
