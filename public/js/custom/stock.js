      ...
      success: function success(response) {
        ...
        response.products.forEach(function (product) {
          ...
          purchased_product_array.push({
            'purchase_prod_id': "".concat(product.id),
            ...
            'sale_price': "".concat(product.sale_price)
          });
        ...
        purchased_product_array.forEach(function (product, key) {
          x++;
          $('#designationsTable tbody').append("\n                        <tr id='tr-".concat(product.product_id, "' data-prod_id =\"").concat(product.product_id, "\">\n                            <td>").concat(product.product_id, "</td>\n                            <td style=\"width : 200px;max-width: 200px;\" colspan=\"2\">").concat(product.p_name, "</td>\n                            <td  style=\"width : 95px\"><input type=\"number\" value=\"").concat(product.purchased_price, "\" data-purchase=\"").concat(product.purchased_price, "\" data-stock=\"").concat(product.stock_in_hand, "\" class=\"inputSale price-input add-stock-input td-").concat(product.product_id, "\"  data-id=\"").concat(product.product_id, "\" data-value=\"").concat(amount, "\" data-quantity=\"").concat(product.qty, "\"  style=\"font-size: 13px;width:100%\" min=\"0\"></td>\n                            <td style=\"width : 95px\"><input type=\"number\" value=\"").concat(product.sale_price, "\" data-purchase=\"").concat(product.sale_price, "\" data-stock=\"").concat(product.stock_in_hand, "\" class=\"inputSale sale_price_input td-").concat(product.product_id, "\"  data-id=\"").concat(product.product_id, "\"   style=\"font-size: 13px;width:100%\" min=\"0\"></td>\n                             <td><input type=\"date\" value=\"").concat(product.expiry_date, "\" class=\"inputSale expiry_date expiry_input\"  data-id=\"").concat(product.product_id, "\" style=\"font-size: 13px;width: 95;\" min=\"0\" ></td>\n                            <td style=\"width : 80px\">\n                                <input type=\"number\" value=\"").concat(product.qty, "\" data-purchase=\"").concat(product.old_price, "\" data-stock=\"").concat(product.stock_in_hand, "\"\n                                class=\"inputSale qty-input add-stock-input td-input-qty").concat(product.product_id, "\"  data-id=\"").concat(product.product_id, "\" data-value=\"").concat(amount, "\" data-quantity=\"").concat(product.qty, "\"\n                                style=\"font-size: 13px\" min=\"0\" style=\" width: 100%;\">\n                            </td>\n                            <td class='purchase-product-amount").concat(product.product_id, " add- S-input '>").concat(product.prod_discount, "</td>\n                             <td class='purchase-product-amount").concat(product.product_id, " add- S-input '>").concat((product.amount - product.prod_discount).toFixed(2), "</td>\n                            <td  style=\"width: 80px;\"><a style=\"width: 100%;\" type=\"button\" id=\"").concat(product.product_id, "\" data-product-invoice=\"").concat(product.purchase_prod_id, "\" data-id=\"").concat(product.purchase_invoice_id, "\" class=\"btn smBTN red-bg remove_btn\" data-index=\"\" style=\"").concat(!is_removable ? 'display:none' : '', "\" data-stock=\"").concat(product.stock_in_hand, "\" data-quantity=\"").concat(product.qty, "\">Remove</a></td>\n                        </tr>\n                    "));
        });
...
$(document).on('click', '.remove_btn', function () {
  ...
  if (parseInt(current_stock) < parseInt(purchased_qty)) {
    $('#notifDiv').fadeIn().css('background', 'red').text("Current stock is less then ".concat(current_stock, " -- ").concat(purchased_qty));
    setTimeout(function () {
      $('#notifDiv').fadeOut();
    }, 3000);
    return;
...
$('#add-product').on('click', function () {
  var is_in_array = purchased_product_array.filter(function (x) {
  ...
  if (is_in_array.length > 0) {
    ...
    purchased_product_array.push({
      ...
      'sale_price': "".concat(sale_price),
      'purchased_price': "".concat(new_price ? new_price : old_price)
    });
    ...
    $('#designationsTable tbody').append("\n            <tr id='tr-".concat(product_id, "' data-prod_id =\"").concat(product_id, "\">\n                <td>").concat(product_id, "</td>\n                <td style=\"width : 200px;max-width: 200px;\"  colspan=\"2\">").concat(p_name, "</td>\n                <td style=\"width : 95px\"><input type=\"number\" value=\"").concat(purchased_price, "\" data-purchase=\"").concat(purchased_price, "\" data-stock=\"").concat(stock_in_hand, "\" class=\"inputSale price-input add-stock-input td-").concat(product_id, "\"  data-id=\"").concat(product_id, "\" data-value=\"").concat(amount, "\" data-quantity=\"").concat(qty, "\"  style=\"font-size: 13px;width:100%\" min=\"0\"></td>\n                <td style=\"width : 95px\"><input type=\"number\" value=\"").concat(sale_price, "\" data-purchase=\"").concat(sale_price, "\" data-stock=\"").concat(stock_in_hand, "\" class=\"inputSale sale_price_input  td-").concat(product_id, "\"  data-id=\"").concat(product_id, "\" data-value=\"").concat(amount, "\" data-quantity=\"").concat(qty, "\"  style=\"font-size: 13px;width:100%\" min=\"0\"></td>\n                <td><input type=\"date\" value=\"").concat(expiry_date, "\" class=\"inputSale expiry_date expiry_input\"  data-id=\"").concat(product_id, "\" style=\"font-size: 13px;width: 95;\"   ></td>\n\n                <td style=\"width : 80px\">\n                    <input type=\"number\" value=\"").concat(qty, "\" data-purchase=\"").concat(purchased_price, "\" data-stock=\"").concat(stock_in_hand, "\"\n                            class=\"inputSale qty-input add-stock-input td-input-qty").concat(product_id, "\"  data-id=\"").concat(product_id, "\" data-value=\"").concat(amount, "\" data-quantity=\"").concat(qty, "\"\n                            style=\"font-size: 13px;width:100%;\" min=\"0\" >\n                </td>\n                <td style-\"width:90px\"><input type=\"number\" value=\"").concat(prod_discount, "\"  class=\"inputSale discount-input add-stock-input td-").concat(prod_discount, "\"  data-id=\"").concat(product_id, "\"  data-value=\"").concat(amount, "\" data-quantity=\"").concat(qty, "\"  style=\"font-size: 13px;width:100%\" min=\"0\"></td>\n                <td class='purchase-product-amount").concat(product_id, " add- S-input ' style=\"width: 60;\">").concat(amount - prod_discount, "</td>\n                <td><button type=\"button\" id=\"").concat(product_id, "\" class=\"btn smBTN red-bg remove_btn\" data-index=\"\">Remove</button></td>\n            </tr>"));
    grandSum(previous_payable);
    $('#purchase_price').val('');
    $('#qty').val('');
    $('#amount').val('');
...
function grandSum() {
  ...
  purchased_product_array.forEach(function (data, key) {
    ...
    $('.product_net_total').val(addCommas(sum));
  ...
  $('.grand-total').text(addCommas(sale_total_amount));
