                    ...
                    <div class="row">
                        <div class="col">
                            <div class="CL-Product inputmonth"><i class="fa fa-calendar-alt"></i>
                                <input type="text" autocomplete="off" class="form-control" value="{{date('d-M-Y')}}"
                                    placeholder="Close Date" readonly>
                                    <input type="hidden" value="{{date('Y-m-d')}}" class="close_date">
                            </div>
                            <div class="_cust_filter col-3">
                                <div class="form-s2">
                                    <select class="form-control formselect company_id" name="company_id">
                                        <option value="">Select Company</option>
                                        @foreach ($companies as $company)
                                            <option value="{{ $company->id }}">
                                                {{ $company->id }}-{{ $company->company_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-s2">
                                    <select class="form-control formselect product_id" name="product_id">
                                        ...
                                        @foreach ($products as $company)
                                            <option value="{{ $company->id }}">
                                                {{ $company->id }}-{{ $company->product_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-md-3 mb-30">
            <div class="card cp-stats">
                <div class="cp-stats-icon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                            ...
                            <div class="col-md-4">
                                <div class="c-address-info">
                                    ...
                                    <div style="border-bottom: 1px solid #f4f4f4;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-credit-card-2-front" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <div style="border-bottom: 1px solid #f4f4f4;">
                                        ...
                                        <strong class="digit total_sales">Loading...</strong>
                                    </div>
                                    <div style="border-bottom: 1px solid #f4f4f4;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-wallet" viewBox="0 0 16 16">
                                        ...
                                        <span> <b>Cash Recovery:</b> </span>
                                        <strong class="digit cash_recovery">Loading...</strong>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">
                                    ...
                                    <div style="border-bottom: 3px solid #f4f4f4;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">
                                            <path
                                                d="M1.92.506a.5.5 0 0 1 .434.14L3 1.293l.646-.647a.5.5 0 0 1 .708 0L5 1.293l.646-.647a.5.5 0 0 1 .708 0L7 1.293l.646-.647a.5.5 0 0 1 .708 0L9 1.293l.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .801.13l.5 1A.5.5 0 0 1 15 2v12a.5.5 0 0 1-.053.224l-.5 1a.5.5 0 0 1-.8.13L13 14.707l-.646.647a.5.5 0 0 1-.708 0L11 14.707l-.646.647a.5.5 0 0 1-.708 0L9 14.707l-.646.647a.5.5 0 0 1-.708 0L7 14.707l-.646.647a.5.5 0 0 1-.708 0L5 14.707l-.646.647a.5.5 0 0 1-.708 0L3 14.707l-.646.647a.5.5 0 0 1-.801-.13l-.5-1A.5.5 0 0 1 1 14V2a.5.5 0 0 1 .053-.224l.5-1a.5.5 0 0 1 .367-.27zm.217 1.338L2 2.118v11.764l.137.274.51-.51a.5.5 0 0 1 .707 0l.646.647.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.509.509.137-.274V2.118l-.137-.274-.51.51a.5.5 0 0 1-.707 0L12 1.707l-.646.647a.5.5 0 0 1-.708 0L10 1.707l-.646.647a.5.5 0 0 1-.708 0L8 1.707l-.646.647a.5.5 0 0 1-.708 0L6 1.707l-.646.647a.5.5 0 0 1-.708 0L4 1.707l-.646.647a.5.5 0 0 1-.708 0l-.509-.51z" />
                                        ...
                                        <strong class="digit total_payments">Loading...</strong>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
                            ...
                            <div class="col-md-8">
                                <div style="min-height:;" class="loader">
                                    <img src="images/loading.gif" width="30px" height="auto"
                                        style="position: absolute; left: 65%; top: 45%;">
                                </div>
