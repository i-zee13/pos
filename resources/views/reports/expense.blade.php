    ...
    <div class="row  ">
        <div class="col">
            ...
            <h1 class="header-title">
                <h2 class="_head01">Expense<span> Report</span></h2>
            </h1>
        </div>
        <div class="col-auto">
            <ol class="breadcrumb">
                ...
                <div class="col-lg-7 col-md-12 ">
                    <div class="row">
                        <div class="col-12 position-relative">
                            ...
                            <h2 class="card-heading">Total <span> Expense</span></h2>
                            <div class="total-amount ttl_expenses p-0"><span>Rs.</span> 0</div>
                        </div>
                        <div class="col-12">
    ...
    <div class="col-md-12">
        <div class="card report-list-card" style="padding: 0px">
            <div class="header m-0">
                <h2 style="width: 100%">Expense <span>List</span>
            ...
            <div class="body teacher_attendance_list">
                <div class="col-12 pb-10">
                    <div class="no-info">
                        <div class="m-auto"><strong> Please Filter Your Expense Record !</strong></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
                ...
                <table class="table table-hover dt-responsive nowrap TeacherAttendanceListTable" style="width:100%;">
                    ...
                    $('.TeacherAttendanceListTable tbody').append(`
                            <tr class="report-grand-total-row" style="background: #040725;border: solid 1px #dbdbdb;color: white"> 
                                ...
                                <td class="totalNo" >
                                    <span class="grand-total dt-report-num">${addCommas(ttl_expense.toFixed(2)) } <span class="dt-report-pct" style="color: ${total_avg_profit > 0 ? '#29f129' : 'red' };">${ttl_expense.toFixed(2)}% </span></span>
                                </td>
                            </tr>
                     `);
        ...
        function reportTable(element, formattedDate, avg_profit) {
            $('.TeacherAttendanceListTable tbody').append(`
                    <tr>
                        <td>${element['cpv_no']}</td>
                        <td>${formattedDate}</td>   
                        <td>${element['comment']}</td>    
                        <td class="dt-report-num"><i  class="fa fa-arrow-down text-danger"></i>  <strong class="dt-report-num">${addCommas(element['dr'])}</strong> </td>
                    </tr>`);
        }
    ...
    $('.ttl_expenses').html('<span>Rs.</span> 0');
    $('.ttl_payment').html(0);
    $('.ttl_quantity').html(0);
    ...
    $('.teacher_attendance_list').append(`
            <div class="col-12 pb-10">
            <div class="no-info">
                <div class="m-auto"><strong>Please Filter Your Expense Report !</strong></div>
            </div>
        </div>
        `);
})
