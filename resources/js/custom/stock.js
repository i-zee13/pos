                    ...
                    $('#designationsTable tbody').append(`
                        <tr id='tr-${product.product_id}' data-prod_id ="${product.product_id}">
                            ...
                            <td class='purchase-product-amount${product.product_id} add- S-input '>${product.prod_discount}</td>
                             <td class='purchase-product-amount${product.product_id} add- S-input '>${(product.amount - product.prod_discount).toFixed(2)}</td>
    ...
    if (is_in_array.length > 0) {
        ...
        $('#designationsTable tbody').append(`
            <tr id='tr-${product_id}' data-prod_id ="${product_id}">
                <td>${product_id}</td>
                <td style="width : 200px;max-width: 200px;"  colspan="2">${p_name}</td>
                <td style="width : 95px"><input type="number" value="${purchased_price}" data-purchase="${purchased_price}" data-stock="${stock_in_hand}" class="inputSale price-input add-stock-input td-${product_id}"  data-id="${product_id}" data-value="${amount}" data-quantity="${qty}"  style="font-size: 13px;width:100%" min="0"></td>
                <td style="width : 95px"><input type="number" value="${sale_price}" data-purchase="${sale_price}" data-stock="${stock_in_hand}" class="inputSale sale_price_input  td-${product_id}"  data-id="${product_id}" data-value="${amount}" data-quantity="${qty}"  style="font-size: 13px;width:100%" min="0"></td>
                ...
                <td style-"width:90px"><input type="number" value="${prod_discount}"  class="inputSale discount-input add-stock-input td-${prod_discount}"  data-id="${product_id}"  data-value="${amount}" data-quantity="${qty}"  style="font-size: 13px;width:100%" min="0"></td>
