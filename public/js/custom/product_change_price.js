...
function ProductTable(filtered_Array) {
  ...
  filtered_Array.forEach(function (element, key) {
    $('.productTable tbody').append("\n            <tr data-product-id=\"".concat(element.id, "\">\n                <td>").concat(key + 1, "</td>\n                <td>").concat(element.product_name, "</td>\n                <td class=\"").concat(key + 1, "-purchase-price\">").concat(element.new_purchase_price ? element.new_purchase_price : element.old_purchase_price, "</td>\n                <td><input type=\"number\" min='0' class=\"inputvalue only_numerics\" value=\"").concat(element.sale_price, "\"  data-purchase=\"").concat(element.new_purchase_price ? element.new_purchase_price : element.old_purchase_price, "\"  data-id=\"").concat(key + 1, "\" name=\"sale_price\" tabindex=\"3\" min=\"0\"></td>\n                <td class=\"").concat(key + 1, "-profit\"></td>\n                <td><button type=\"button\" class=\"btn btn-primary smBTN mr-2 add-new-price\" tabindex=\"8\" style=\"padding: 5px 15px 5px 15px; background:green\" data-id=\"").concat(key + 1, "\">Add</button></td>\n            </tr>\n        "));
