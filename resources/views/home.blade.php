  ...
  <div class="col-lg-12 col-md-12 col-sm-12">
    <div class="card BookedSales total-sale p-15">
      ...
      <div class="row total-vals border-right-0" id="visitsStats">
        <div class="col"><span class="empty-span" style="cursor: pointer;">---</span> <span class="hide" style="display: none;">{{number_format($total_sale - $ttl_sale_return)}}</span>Total Sale</div>
        <div class="col bg-shade"><span class="empty-span" style="cursor: pointer;">---</span> <span class="hide" style="display: none;">{{number_format($ttl_sale_return)}}</span>Total Sale Returns</div>
        <div class="col"><span class="empty-span" style="cursor: pointer;">---</span> <span class="hide" style="display: none;">{{number_format($total_purchase)}}</span>Total Purchase</div>
        <div class="col bg-shade"><span class="empty-span" style="cursor: pointer;">---</span> <span class="hide" style="display: none;">{{number_format($expense)}}</span>Total Expense</div>
      </div>
    </div>
  </div>
</div>
