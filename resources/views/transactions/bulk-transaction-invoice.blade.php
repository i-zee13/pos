...
<head>
    <meta charset="UTF-8">
    <title>Customer Ledger</title> <style>
        @media print {
            @page {
    size: 80mm 297mm; /* Custom page size */
    margin: 0; /* Remove any default margins */
}

#invoice-POS {
    width: 72mm; /* Slightly smaller than paper width to avoid clipping */
    padding: 4mm; /* Optional padding */
}
        ...
        #invoice-POS #bot .footer-copyright .copyright {
            font-size: 10px;
            color: #232323;
        }

        #invoice-POS #bot .bot-3-table .body-description-tr {
            border-bottom: 1px solid #444444;
            border-bottom-style: dashed;
            color: #000000;
        }
...
<body translate="no" onload="javascript:window.print()">
    ...
    <div id="invoice-POS">
        <center id="top">
            <div class="info">
                 <b> <img src="{{ org_print_logo_url($organization ?? null) }}" class="" alt="..." style="height:60px;margin:0px"> 
        ...
        <div id="bot">
            ...
            <table class="bot-2-table">
                <tr>
                    <td>Customer: <span style="text-transform:capitalize">Ledger</span></td>
                </tr>
            </table>
            <table class="bot-3-table">
                ...
                <tr class="body-description-tr"> 
                    ...
                    <td class="tableitem" style="text-align:center">{{$customer['balance']}}</td> 
                    <td class="other-des-td"></td>
                </tr>
                @endforeach
            </table>
            <table class="bot-4-table">
                <tr>
                    <td>T Custs: {{count($customers)}}</td>
                    <td class="net-total">Total {{collect($customers)->sum('balance')}}</td>
                    <td>&nbsp;&nbsp;</td>
                </tr>
            </table>
