    ...
    <div class="container-fluid">
        <form id="form" enctype="multipart/form-data" class="">
            ...
            <div class="row">
                ...
                <div class="col-auto left-si debox ">
                    <button class="btn btn-primary mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#invoiceDetails" aria-expanded="false" aria-controls="invoiceDetails">
                ...
                <div class="col-md-9 right-sid ebox">
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="right_Info">
                            ...
                            <div class="col-12" id="table-container">
                                <table class="ProductTable table  " id="designationsTable" width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody id="productGrid">
                                        <tr>
                                            <td><input type="text" id="bar-code" class="inputSale bar-code" placeholder="" name="bar_code" data-attr='bar_code' tabindex="1" style="width: 75;"></td>
                                            ...
                                            <td> <input type="number" id="new_purchase_price" class="inputSale" placeholder="" name="new_purchase_price " tabindex="3" style=" width: 60px;" min="0"></td>
                                            ...
                                            <td style="width: 80px;"> <input type="text" id="qty" class="inputSale only_numerics" placeholder="" name="qty" tabindex="6" min="0" style=" width: 100%;"></td>
                                            ...
                                            <td class='add- S-input ' style="width:100px"><input type="text" id="amount" class="inputSale" placeholder="" name="amount" style="font-size: 13px;width: 90px;"></td>

                                            <td>
                                                <button type="button" id="add-product" class="btn btn-primary smBTN mr-2" tabindex="8" style="padding: 5px 15px 5px 15px; background:green;width:100%">Add</button>
                                            </td>
                                        </tr>
                        ...
                        <div style="background-color: #f6f6f6; padding:10px; margin-top: 15px; text-align: right; margin-bottom: 1px" id="btns_div">
                            @if(request()->query('invoice') == 'detail')
