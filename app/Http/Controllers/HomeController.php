...
class HomeController extends Controller
{
      ...
      public function index()
    {
        ...
        $total_net_sale_returns_invoice_amount         =  collect($saleRecords['sale_returns'])->WHERE('invoice_type', 1)->unique('invoice_no')->unique('invoice_no')->SUM('total_invoice_amount'); //zee
        $total_credit_sale_returns_amount_received     =  collect($saleRecords['sale_returns'])->WHERE('invoice_type', 2)->unique('invoice_no')->SUM('paid_amount'); //zee
        //END Returns
        ...
        return view('home', compact('message', 'total_sale','ttl_sale_return','ttl_in_hand', 'total_purchase','expense','total_net_sale_returns_invoice_amount'));
    }
