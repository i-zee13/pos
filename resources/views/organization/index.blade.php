  ...
  <div class="container">
    <form id="form" enctype="multipart/form-data" class="">
      ...
      <div class="row">
        ...
        $refundValue = ($data != null && $data->refund_policy != '') ? $data->refund_policy : $defaultRefund;
        @endphp
        <div class="col-md-12">
          <div class="card mb-30">
            <div class="header">
              <h2>Print <span> Section</span></h2>
            </div>
            <div class="body PT-15">
              <div class="form-wrap p-0">
                <div class="row">
                  <div class="col-md-8 mb-20">
                    <div class="form-group mb-0">
                      ...
                      <textarea class="form-control" rows="8" name="refund_policy" dir="auto" placeholder="Refund policy yahan likhein..." style="line-height:2.2; padding:12px 15px; font-size:15px; min-height:170px; resize:vertical;">{{ $refundValue }}</textarea>
                      <small class="text-muted d-block mt-10">Har nai line alag line par print hogi.</small>
                    </div>
                  </div>
