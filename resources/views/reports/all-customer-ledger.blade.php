    ...
    <div class="row  ">
        <div class="col">
            ...
            <h1 class="header-title">
                <h2 class="_head01">Grand<span> Turnover</span></h2>
            </h1>
        </div>
        <div class="col-auto">
            <ol class="breadcrumb">
                ...
                <div class="row justify-content-between d-flex">
                    <div class="col-lg-6 col-md-12 mb-20 ">
                        <div class="card mh-100">
                            <div class="d-flex justify-content-between" style="border-bottom: 2px solid #0038ba;">
                            ...
                            <div class="ttl_in"> 
                                @foreach ($credit_customers as $customer)
                                    <a class="key-trend" data-toggle="collapse" href="#collapse_${index}" role="button" aria-expanded="false" aria-controls="collapse_${index}"> 
                                        <div class="row">
                                            <div class="col key-lab pr-0"><strong>{{$customer->id }} - {{$customer->customer_name}}</strong></div> 
                                            <div class="col key-val pl-0 productivity">{{number_format($customer->balance, 2)}} DR</div>
                                        </div>
                                    </a>  
                                @endforeach    
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 mb-20 ">
                        <div class="card mh-100">
                            ...
                            <div class="ttl_out">
                                @foreach ($debit_customers as $customer)
                                    <a class="key-trend" data-toggle="collapse" href="#collapse_${index}" role="button" aria-expanded="false" aria-controls="collapse_${index}"> 
                                        <div class="row">
                                            <div class="col key-lab pr-0"><strong>{{$customer->id }} - {{$customer->customer_name}}</strong></div> 
                                            <div class="col key-val pl-0 productivity">  {{number_format(abs($customer->balance), 2)}} CR</div>
                                        </div>
                                    </a>  
                                @endforeach
                            </div>
