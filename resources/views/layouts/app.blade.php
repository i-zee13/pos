...
<head>
  ...
  <link href="{{asset('/css/wizard.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/css/style.css?v=7.6')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/css/menu.css?v=6.6')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('/css/product.css?v=8.4')}}" />
