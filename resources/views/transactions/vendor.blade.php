                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto pl-0">
                                                            <div class="custom-control custom-radio">
                                                                <input class="custom-control-input cr" type="radio" name="amount_to" id="cr" value="1" {{request()->segment(1) == $operation.'-ledger-banam' ? 'checked' : '' }}>
                                                                <label class="custom-control-label font13" for="cr">Cr</label>
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="custom-control custom-radio">
                                                                <input class="custom-control-input dr" type="radio" name="amount_to" id="dr" value="0" {{request()->segment(1) == $operation.'-ledger-jama' ? 'checked' : '' }}>
...
@endsection
@push('js')
<script src="{{asset('js/custom/vendor_transaction.js')}}?v=8"> </script>
@endpush