...
<div class="row">
    <div class="col-lg-12">
        <div class="Product-Filter report-filter-inline">
            <form id="search-form">
                <div class="row report-filter-fields">
                ...
                <div class="row report-filter-actions">
...
@endsection
@push('js')
<script src="{{asset('js/custom/sale_report.js?v=1.3') }}"></script>
@endpush