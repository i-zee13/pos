...
<style>
    ...
    .dashboard-date .form-control, .total-sale .total-amount, .unit-v span, .total-val span, .key-trend .key-val, .strength .Strength-val, .emp-val-box span, .avg-booking span, .avg-state .col span, .font-digit, .progressValue, .pr-st span, .avg-booking-day h2 span, .segmentType-value, .empsale, .sale-pu span, .empvisits span, .total-bs .total-amount, .pr-unit-v span, .total-VO span, .total-time, .total-stime .time-s span, .key-tr-list span, .sale-val span, .productcard .productvalue span, .total-vals span, .keytrend-lr span, .ex-avg-booking span, .dis-vs-value, .dash-order-list .dash-ord-price {
        font-family: 'Rationale', sans-serif!important; font-size: 18px;
    ...
    .avg-booking span, .avg-state .col span {
        display: block;
        line-height: 1;
        font-size:19px;
        margin-bottom: 5px;
    ...
    .productcard .total-progress .progress::after, .productcard .total-progress .progress .progress-bar {
        border-width: 4px;
    }
    .dash-filter {
        width: 23px;
    ...
    .et-topsec .strength .Strength-val, .et-topsec .emp-val-box span {
        font-size: 25px
    }
    ...
    .divisional-reports .profile-center .nav-pills .nav-link, .divisional-reports ._report-Head .nav-pills .nav-link {
        margin: 0;
        padding: 5px 20px;
    }
    ...
    .top1-employee .avg-state span {
        letter-spacing: normal; font-size: 19px; margin-top: 9px;
    }
    .dash-order-list{
    ...
    .dash-order-list:hover{background-color:#f9f9f9}
    .posm-img {
    ...
    .PR-Thumb {height: auto; padding-bottom: 8px;}
    .overflow-scroll{overflow-y: auto; height: 283px; padding-right: 5px; overflow-x: hidden;}
    .lg-pr-15{padding-right:15px;}


    .mt-date{margin-top:-10px !important}
    .trending_emp_name{margin:25px 0px; display:block}


    @media (max-width: 1280px) {
    .empvisits .col-6{letter-spacing: normal; padding-left: 8px; padding-right: 8px;}
    }
    ...
    .keytrend-lr{letter-spacing: normal;}
    .top-units-list{letter-spacing: normal;}
    .productcard .pro-pic {
        width: 40px;
        height: 40px; 
    }
    ...
    .productcard h4 {
        font-size: 13px;
        letter-spacing: 0;}
    .unit-v span{font-size: 22px;}
    .avg-booking-day h2{font-size: 16px;}
    .set-icon-size .col{padding-left: 6px;}
    .ex-avg-booking .avg-val{font-size: 22px;}
    .key-trend .key-lab{font-size: 14px;} 
    .key-trend .key-val{font-size: 22px;}
    .pr-st span{font-size: 18px;} 
    .pr-st{font-size: 11px;}
    .L-1024-overflow{width:100%; overflow-x: scroll;}
    .p-1024-width{width:1000px;} 
    .evb-set { 
        font-size: 10px!important; 
    }
    .mt-date{margin-top:-5px !important}
    .product-card h3 {
        font-size: 12px; 
        line-height: 17px;
        height: 36px; 
    ...
    .product-card:before {top: 10px;}
    }
    @media (max-width:992px) {
    .emp-val-box{padding: 15px 1px 5px 6px;}
    .avg-state{font-size: 13px !important;}
    .card-heading {letter-spacing: normal}
    }
    @media (max-width: 800px) {
    .lg-pr-15{padding-right:0;}
    .overflow-scroll{overflow-y: none; height: auto; padding-right: 0px; overflow-x: none;}
    .top-units-800{padding-right: 0 !important; padding-bottom: 20px !important; padding-top: 20px !important;}
    .mb-30-L800{ margin-bottom: 30px;}
    .pr-0-L800{padding-right:0 !important;}
    .mr-0-L800{margin-right:0 !important;}
    .PR-WL800-set{max-width: 115px !important;}
    .NO-WL800-set{max-width: 40px !important; padding: 0;}
    .top-units-list{letter-spacing: 1px;}
    .total-sale .total-amount{font-size: 35px;}
    .unit-v span {font-size: 20px; letter-spacing: 0.5px;}
    .total-val span {font-size: 26px;}
    .avg-booking{margin:15px 0 0 0 ;}
    .top1-employee{margin-top: 15px;}
    .top1-employee {margin-top: 15px; padding-top: 15px;}
    .set-widthCol {
        flex: 0 0 100%;
        max-width: 100%; margin-bottom: 30px;
    }
    .emp-val-box span{font-size: 28px;}
    .strength .Strength-val{font-size:33px;}
    .top1-employee .avg-state span{font-size:22px;}
    .total-val {padding: 10px;}
    .trending_emp_name{margin:10px 0px; display:block}
    }
    ...
    <div class="row  ">
        <div class="col">
            ...
            <h1 class="header-title">
                <h2 class="_head01">Profit<span> Report</span></h2>
            </h1>
        </div>
        <div class="col-auto">
            <ol class="breadcrumb">
                <li><a href="#"><span>Profit</span></a></li>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="header m-0">
                <h2 style="width: 100%">Sale Profit  <span>List</span> <p style="text-align: right;margin:-20px 0px 0px 0px;font-size: 15px;" class="filter_name"></p></h2>
            ...
            <div class="body teacher_attendance_list">
                <div class="col-12 pb-10">
                    <div class="no-info">
                        <div class="m-auto"><strong> Please Filter Your Profit Record !</strong></div>
                    </div>
                </div>
            </div>
        </div>
...
@endsection
@push('js')
<script src="{{asset('js/custom/profit_report.js') }}"></script>
@endpush