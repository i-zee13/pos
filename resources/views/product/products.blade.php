                                            ...
                                            <div class="row">
                                                <div class="col-md-6 PB-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="product_name" class="form-control field-required" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 PB-10">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 PB-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="purchase_price" class="form-control field-required" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 PB-10">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10">Sale Price *</label>
                                                        <input type="text" name="sale_price" class="form-control field-required" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
