...
Latest packaged version in `package.json`: **0.3.6**  
Artifact name: `StoreeoPOS-Setup-0.3.6.exe` (under `desktop/dist/` when built; large binaries may not be on every clone).
