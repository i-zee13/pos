        ...
        <div class="Product-Filter">
           <form id="search-form">
                <div class="row">
                    ...
                    <div class="col-auto report-filter-date" style="padding: 0px;display:none">
    ...
    <div class="col-md-12">
        <div class="card report-list-card" style="padding: 0px">
            <div class="header m-0">
                <h2 style="width: 100%">Sale Profit <span>List</span>
...
@endsection
@push('js')
<script src="{{asset('js/custom/profit_report.js?v=1.7') }}"></script>
<script>
(function () {
    function toggleProfitReportFilters(reportType) {
        if (reportType == 1) {
            $('.hide').css('display', '');
    ...
    $(document).on('change select2:select', '.report_type', function () {
        toggleProfitReportFilters($(this).val());
    });
    $(function () {
        toggleProfitReportFilters($('.report_type').val());
    });
})();
</script>
@endpush