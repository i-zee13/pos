...
<style>
    ...
    .cp-stats {
        border-bottom: solid 0.125rem #00216d;
                        ...
                        <div class="col-md-6 demo-y" id="adminCloseSummaryCol" style="max-height: 430px">
                            <div class="c-address-info">
                                ...
                                <div class="discount_div" style="display: none;">
                                    <i class="fa fa-percent" style="width:16px;text-align:center;margin-right:4px;"></i>
                                    <span> Discount: </span>
                                ...
                                <div class="total_sale_returns_div" style="display: none;">
                                    <i class="fa fa-undo" style="width:16px;text-align:center;margin-right:4px;"></i>
                                ...
                                <div class="total_credit_sale_returns_div" style="display: none;">
                                    <i class="fa fa-reply" style="width:16px;text-align:center;margin-right:4px;"></i>
                                ...
                                <div class="openning_balance_div" style="display: none;">
                                    <i class="fa fa-university" style="width:16px;text-align:center;margin-right:4px;"></i>
                                ...
                                <div class="vendor_recovery_div" style="display: none;">
                                    <i class="fa fa-truck" style="width:16px;text-align:center;margin-right:4px;"></i>
                                ...
                                <div class="credit_return_payment_div" style="display: none;">
                                    <i class="fa fa-reply-all" style="width:16px;text-align:center;margin-right:4px;"></i>
                                ...
                                <div class="total_pr_paid_amount_div" style="display: none;">
                                    <i class="fa fa-shopping-bag" style="width:16px;text-align:center;margin-right:4px;"></i>
                                ...
                                <div class="customer_payments_div" style="display: none;">
                                    <i class="fa fa-user-plus" style="width:16px;text-align:center;margin-right:4px;"></i>
                                ...
                                <div class="total_payments_div" style="border-bottom: 3px solid #f4f4f4;color: white;background: #00216d;display:none">
                                    <i class="fa fa-credit-card" style="width:16px;text-align:center;margin-right:4px;"></i>
