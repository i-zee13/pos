                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 p-col-R">
                                    <div class="form-group">
                                        ...
                                        <p>{{ (Auth::user()->sin ? Auth::user()->sin : "NA") }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 p-col-L">
                                    <div class="form-group">
                                        ...
                                        <p>{{ (Auth::user()->city ? Auth::user()->city : "NA") }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6 p-col-R">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6 p-col-L">
                                    <div class="form-group">
                                        ...
                                        <p>{{ $designation->designation ? $designation->designation:'NA' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6 p-col-R">
                                    <div class="form-group">
                                        <label class="control-label mb-10">Reporting To</label>
                                        <p>{{ $reporting_to->name ? $reporting_to->name:'NA' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
