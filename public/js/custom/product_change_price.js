...
$('.search-btn').on('click', function () {
  ...
  var filtered_Array = [];
  if (product_id) {
    filtered_Array = filterd_products_list.filter(function (x) {
...
function ProductTable(filtered_Array) {
  ...
  $('.products-table').append("\n        <table class=\"table table-hover productTable\" style=\"width:100%;\">\n            <thead>\n                <tr>\n                    <th>ID#</th>\n                    <th>Product Name</th>\n                    <th>Purchase Price</th>\n                    <th>New Price</th>\n                    <th>Profit</th>\n                    <th>Action</th>\n                </tr>\n\n            </thead>\n            <tbody></tbody>\n        </table>\n    ");
  filtered_Array.forEach(function (element, key) {
    $('.productTable tbody').append("\n            <tr data-product-id=\"".concat(element.id, "\">\n                <td>").concat(key + 1, "</td>\n                <td>").concat(element.product_name, "</td>\n                <td class=\"dt-amount ").concat(key + 1, "-purchase-price\">").concat(element.new_purchase_price ? element.new_purchase_price : element.old_purchase_price, "</td>\n                <td><input type=\"text\"  class=\"inputvalue only_numerics\" value=\"").concat(element.sale_price, "\"  data-purchase=\"").concat(element.new_purchase_price ? element.new_purchase_price : element.old_purchase_price, "\"  data-id=\"").concat(key + 1, "\" name=\"sale_price\" tabindex=\"3\" min=\"0\"></td>\n                <td class=\"").concat(key + 1, "-profit\"></td>\n                <td><button type=\"button\" class=\"btn btn-primary smBTN mr-2 add-new-price\" tabindex=\"8\" style=\"padding: 5px 15px 5px 15px; background:green\" data-id=\"").concat(key + 1, "\">Add</button></td>\n            </tr>\n        "));
...
function percentage(dataId) {
  var salePrice = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var purchasePrice = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
